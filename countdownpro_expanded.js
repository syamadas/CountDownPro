/* New Changes (c)2015 Scott Gahres */
/* Originally Licensed CopyLeft
...
function CD_M(strTagId) {
    ...
    if (objMeta && objMeta.length) {
        ...
        for (var i = 0; i < objMeta.length; ++i) {
            ...
            /* we use class instead of scheme to be html5 compliant */
            if (objMeta.item(i).className == strTagId) {
...
function CD_T(strTagId) {
    ...
    if (objW.intEvntDte <= objNow.valueOf()) {
        if (objW.event_functionhandler) {
            /* is there a jquery method named in the meta? */
            if (typeof $ === "function" && typeof $() === "object" && typeof $()[objW.event_functionhandler] === "function") {
                $()[objW.event_functionhandler](new Date(objW.intEvntDte));
                objW.event_functionhandler = "";
            } else {
                if (typeof window[objW.event_functionhandler] == "function") {
